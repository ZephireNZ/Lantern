 ...
 */
public final class LanternChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public LanternChannelInitializer(ConnectionManager connectionManager) {
