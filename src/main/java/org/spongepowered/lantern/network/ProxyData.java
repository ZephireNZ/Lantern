...
public final class ProxyData {
    ...
    private String name;
    private UUID uuid;
//    private List<PlayerProperty> properties; //TODO
     ...
     */
    public ProxyData(LanternSession session, String sourceText) throws Exception {
        //TODO: Implement
...
//        }
     ...
     */
    public GameProfile GameProfile(String name) {
